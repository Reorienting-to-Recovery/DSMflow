...
sj_functional_flows_for_model_dry <- tibble(month = factor(month.abb[1:12], 
                           ...
                           flow_cfs = c(4000, # Jan Wet season base flow + Peak Magnitude flows, based on dry year monthly Natural Flows 
                                        ...
                                        3069, # May Spring recession flow (keep migratory surv at ~20%)
                                        3069, # June Spring recession flow (keep migratory surv at ~20%)
                                        3069, # July half way between dry season baseflow and mig surv 20% threshold
