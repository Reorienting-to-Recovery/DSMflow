...
sac_functional_flows_for_model_wet <- tibble(month = factor(month.abb[1:12], 
                           ...
                           description = c("Wet season base flow + Peak Magnitude flows, based on wet year monthly Natural Flows",
                                           ...
                                           "Fall pulse flow, based on wet year monthly Natural Flows",
                                           "Begin wet season baseflow and medium flow, based on wet year monthly Natural Flows")) 
...
```
```{r, echo = FALSE}
# Process data objects for use in modeling 
# TODO - pull in logic from transform_inputs_complete.R, create all objects with Sac EFF
# TODO think about how to scale EFF to different sac nodes - maybe utalize existing scaling 
sac_eff <- DSMflow::flows_cfs
